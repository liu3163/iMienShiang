...
- (String)getResourcePath:(NSString *)name
{
	NSString *path = [[NSBundle mainBundle] pathForResource:name ofType:@"xml"];
	String * cPath = [path cStringUsingEncoding:NSASCIIStringEncoding];
}
				  ...
				  editingInfo:(NSDictionary *)editingInfo
{
	...
	if (buttonPressed == LEFT_EAR_PICKING)
	{
		...
		leftImage = [self CreateIplImageFromUIImage:image];
	}
	...
	imageView.image = [self scaleAndRotateImage:image toView:imageView];
